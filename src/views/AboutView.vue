<template>
  <head>
    <title>About - Independece Purchasing Company</title>
    <meta
      name="description"
      content="Independence Purchasing Company is a leading procurement services provider specializing in efficient and cost-effective procurement of goods for businesses. Contact us for a consultation."
    />
    <meta
      name="keywords"
      content="Independence Purchasing Company, procurement services, supplier sourcing, contract negotiation, purchase order management"
    />
  </head>
  <div class="about">
    <div class="about-wrap">
      ...
      <div class="about-content-group">
        <div class="about-content" :class="{ suscribe: suscribed }">
          <h1 class="about-header">Be the first to know when we go live.</h1>
          <p class="about-copy">
            We are building digital products to make it easy for you to work with us. Join waitlist.
          </p>
        ...
        <div class="about-content" :class="{ confirmation: confirmed }">
          <h1 class="about-header">Thank you for joining our waitlist</h1>
          <p class="about-copy">We will notify you when we go live.</p>
          <div class="waitlist-cta">
            <form action="/subscribe" method="POST" class="form">
              <div class="form-item">
                <input
