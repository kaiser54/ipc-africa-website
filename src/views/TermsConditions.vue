	...
	<div class="container">
		<div class="bookmark-group">
			...
			<div class="bookmark">
				<a
                  href="#termsandcon"
                  @click.prevent="scrollToHeadline('termsandcon')"
                  >
									Terms and Conditions
									</a>
				<a
                  href="#change"
                  @click.prevent="scrollToHeadline('change')"
                  >
									Changes to This Terms and Conditions
									</a>
				<a
                  href="#contact"
                  @click.prevent="scrollToHeadline('contact')"
                  >
									Contact Us
									</a>
			</div>
		...
		<div class="bookmark-content" >
			<div id="termsandcon" >
				<div class="tops">
					...
					<p class="date">Monday, August 28, 2023</p>
				</div>
				<div id="terms">
					...
					<p class="first">
						...
						itself, and all the trademarks, copyright, database rights, and other intellectual property rights related to
						it, still belong to Independent Purchasing Company Ltd
					</p>
					<p class="second">
						Independent Purchasing Company Ltd is committed to ensuring that the app is as useful and efficient as
						...
						to you exactly what you’re paying for. The IPC app stores and processes personal data that you have provided
						to us, to provide our Service. It’s your responsibility to keep your phone and access to the app secure. We
						therefore recommend that you do not jailbreak or root your phone, which is the process of removing software
						restrictions and limitations imposed by the official operating system of your device. It could make your phone
						vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean
						that the IPC app won’t work properly or at all.
					</p>
					<p class="third">
					...
					<p class="forth">
						You should be aware that there are certain things that Independent Purchasing Company Ltd will not take
						responsibility for. Certain functions of the app will require the app to have an active internet connection.
						The connection can be Wi-Fi or provided by your mobile network provider, but Independent Purchasing Company
						Ltd cannot take responsibility for the app not working at full functionality if you don’t have access to
					...
					<p class="Sixth">
						(a) the rights and licenses granted to you in these terms will end <br />
			...
			<div id="change"> 
				...
				<p>
					...
					terms and conditions are effective as of 2023-08-28
				</p>
			</div>
			<div id="contact">
				<h6>Contact Us</h6>
				<p>
					...
					<a href="#">support@ipc-africa.com</a>
				</p>
			</div>
		</div>
	</div>
...
export default {
	...
	beforeCreate() {
		if (this.$route.path === "/TermsConditions") {
